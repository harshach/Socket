        ...
        HStack(spacing: 12) {
            ...
            ZStack {
                RoundedRectangle(cornerRadius: 6)
                    .fill(profile.gradient.primaryColor.opacity(0.18))
                RoundedRectangle(cornerRadius: 6)
                    .stroke(profile.gradient.primaryColor.opacity(0.35), lineWidth: 1)
            ...
            VStack(alignment: .leading, spacing: 2) {
                ...
                HStack(spacing: 8) {
                    ...
                    Label("Appearance", systemImage: "paintpalette")
                        .font(.caption)
                        .foregroundStyle(profile.gradient.primaryColor)
                }
            }
            ...
            HStack(spacing: 6) {
                ...
                Button(action: onChangeAppearance) {
                    Label("Change Appearance", systemImage: "paintpalette")
                        .labelStyle(.iconOnly)
                }
                .buttonStyle(.borderless)
                .help("Customize profile appearance")
