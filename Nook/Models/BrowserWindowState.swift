...
class BrowserWindowState {
    ...
    /// Sigma-style focus mode hides surrounding chrome for this window.
    ...
    /// Explicit insert mode disables modifier-less shell shortcuts until exited.
    var isInsertModeEnabled: Bool = false
