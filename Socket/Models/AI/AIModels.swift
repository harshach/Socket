...
final class AIKeychainStorage: @unchecked Sendable {
    ...
    private let service = "com.socket.aiProvider"
...
struct AIGenerationConfig: Codable, Equatable {
    ...
    You are a helpful AI assistant integrated into Socket, a modern web browser. Your role is to assist users in real time as they browse the web, helping them understand content, answer questions, and gain deeper insights into the pages they're viewing.
