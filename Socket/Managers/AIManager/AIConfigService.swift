...
class AIConfigService {
    private static let log = Logger(subsystem: Bundle.main.bundleIdentifier ?? "Socket", category: "AIConfig")
    ...
    init() {
        ...
        let socketDir = appSupport.appendingPathComponent("Socket")
        self.configURL = socketDir.appendingPathComponent("ai_config.json")
