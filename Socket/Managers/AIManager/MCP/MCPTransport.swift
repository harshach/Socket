...
final class StdioTransport: MCPTransportProtocol, @unchecked Sendable {
    private static let log = Logger(subsystem: Bundle.main.bundleIdentifier ?? "Socket", category: "StdioTransport")
...
final class SSETransport: MCPTransportProtocol, @unchecked Sendable {
    private static let log = Logger(subsystem: Bundle.main.bundleIdentifier ?? "Socket", category: "SSETransport")
